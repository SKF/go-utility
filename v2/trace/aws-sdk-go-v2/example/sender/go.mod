module github.com/SKF/go-utility/v2/trace/aws-sdk-go-v2/example/sender

go 1.19

replace github.com/SKF/go-utility/v2 => ../../../..

require (
	github.com/SKF/go-utility/v2 v2.0.0-00010101000000-000000000000
